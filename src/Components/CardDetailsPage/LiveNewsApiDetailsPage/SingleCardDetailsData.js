            ...
            <div className='py-10 '>
                <div>
                    ...
                    <div className='flex items-center gap-4 '>
                        ...
                        <h1 className='text-4xl font-semibold'>{data?.source?.name}</h1>
                    </div>
                    <div>
                    ...
                    <div className='py-10'>
                        <h1 className='text-2xl font-semibold'>{data?.source?.name}</h1>
                    ...
                    <div>
                        <h1 className='text-4xl font-semibold'>{data?.allAuth?.name}</h1>
                    </div>
                </div>
