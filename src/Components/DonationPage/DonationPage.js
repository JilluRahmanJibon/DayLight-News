...
const DonationPage = () => {
  ...
  return (
    <div className="w-full mb-20 mt-16  border shadow">
      <section className="p-6  ">
        <form
          onSubmit={handlePayment}
          className="  flex flex-col  ng-untouched ng-pristine ng-valid"
        >
          <div className="mx-auto mb-3">
            <h1 className="text-2xl font-semibold text-red-500">
              Donate Helpless People
            </h1>
          </div>
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              <div className="col-span-full sm:col-span-3">
                ...
                <input
                  ...
                  className="w-full rounded-md border outline-none  p-2 "
                />
              </div>
              <div className="col-span-full sm:col-span-3">
              ...
              <div className="col-span-full">
                <input
                  type="submit"
                  className="w-full bg-black text-white rounded-md p-2 border  cursor-pointer"
                />
              </div>
            </div>
          </div>
