...
const AllCard = ({ data, i }) => {
  ...
  return (
    <NavLink
      to={`/detail/${_id}`}
      className=" w-4/5 md:h-[800px] h-full mx-auto border-2  rounded-t-lg  relative overflow-hidden my-8  gradient1"
    >
      <img
      ...
      <div className="  absolute bottom-2 sm:pl-8 pl-3 md:mb-8 sm:mb-4 mb-2 text-cyan-500  z-40">
        <div className="flex flex-col justify-center">
          ...
          <p className="text-md text-white">{description?.slice(0, 250)}</p>
        </div>
