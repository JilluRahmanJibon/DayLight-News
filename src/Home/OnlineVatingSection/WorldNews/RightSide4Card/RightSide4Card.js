...
const RightSide4Card = ({ data }) => {
  ...
  return (
    <div className="md:mx-3 mb-3 w-full  transition-all xl:w-72 pb-4 ">
      ...
      >
        <div className="overflow-hidden w-full xl:w-72 xl:h-28 ">
          <img
            className=" w-full xl:w-72 xl:h-28 h-64 object-cover ease-in-out duration-500 transform hover:scale-125 "
            src={picture}
            alt=""
          />
        </div>{" "}
